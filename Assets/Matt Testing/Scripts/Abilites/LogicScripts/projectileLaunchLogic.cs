...
public class projectileLaunchLogic : NetworkBehaviour, useAbility, onAbilityPickedup, onAbilityDropped
{
    [Header("Settings")]
    ...
    public void AbilityPickedup(Transform playerTransform)
    {
    ...
    public void AbilityPickupDropped(Transform playerTransform)
    {
        shootingScript = null;
        player = null;
    }
