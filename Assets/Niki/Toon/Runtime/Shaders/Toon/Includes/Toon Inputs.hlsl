#ifndef CUPOFHAPPINESS_TOON_INPUTS_INCLUDED
#define CUPOFHAPPINESS_TOON_INPUTS_INCLUDED
...
//  defines SurfaceData, textures and the functions Alpha, SampleAlbedoAlpha, SampleNormal, SampleEmission
    ...
    #include "Toon SurfaceInputs.hlsl"
...
//  Material Inputs
    ...
    //  TAM global and Shadow/Form layer
        half    _TAMIndirectContribution;
        half    _TAMAOContribution;
        float   _TAMShadowFormProjectionScale;
        half    _TAMShadowFormToneBias;
        half4   _TAMShadowFormInkColor;
        half    _TAMShadowFormInkOpacity;
        half    _TAMShadowFormRange;
        half    _TAMShadowFormOpacity;
        float   _TAMLightProjectionScale;
        half    _TAMLightToneBias;
        half4   _TAMLightInkColor;
        half    _TAMLightInkOpacity;
        half    _TAMLightRange;
        float   _TAMHighlightPunchOutProjectionScale;
        half    _TAMHighlightPunchOutToneBias;
        half    _TAMHighlightPunchOutOpacity;
        half    _TAMLightHighlightTransparency;
        half    _TAMDebugView;
...
//  Toon
    ...
    #include "../../Includes/Toon Lighting.hlsl"
